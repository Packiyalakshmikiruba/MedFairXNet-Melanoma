...
print("=" * 70)
print("HAM10000 DENSENET121 ROI TEST EVALUATION")
print("=" * 70)
...
if not MODEL_PATH.exists():
    raise FileNotFoundError(
        f"DenseNet121 ROI model not found:\n{MODEL_PATH}"
    )
...
print("\nLoading trained DenseNet121 ROI model...")
...
print("\n" + "=" * 70)
print("DENSENET121 ROI EVALUATION COMPLETED")
print("=" * 70)
